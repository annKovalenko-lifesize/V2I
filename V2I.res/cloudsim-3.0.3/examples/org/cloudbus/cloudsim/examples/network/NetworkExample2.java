...
public class NetworkExample2 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//vmlist = createVM_N(broker.getId(), 3,6000, 1);
		...
		for (int i = 0; i < hostNumber; i++) {
			hostList.add(
	    			new Host(
	    				...
	    				storage,
	    				peList,
	    				new VmSchedulerSpaceShared(peList)// SpaceScheduler distribute VMs to different data centers
	    			)
	    		); // This is our machine
